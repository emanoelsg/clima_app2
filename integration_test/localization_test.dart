...
void main() {
  ...
  testWidgets('Buscar clima por cidade inválida retorna erro tratado', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('fetchWeatherByCity atualiza cidade corretamente', (
    tester,
  ) async {
    final controller = WeatherController();
  ...
  testWidgets('getCurrentCity retorna cidade válida', (
    WidgetTester tester,
  ) async {
